...
<template>
  <MainLayout>
    <div class="favorites-page bg-neutral-50 min-h-screen py-16">
      <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto">
          <!-- Header -->
          <div class="text-center mb-12">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-error/20 to-error/10 rounded-3xl mb-6">
          ...
          <!-- Loading -->
          <LoadingSpinner v-if="favoritesStore.loading" size="lg" text="Đang tải..." />

          <!-- Empty State -->
          <div v-else-if="favoritesStore.favorites.length === 0" class="text-center py-16">
            <div class="inline-flex items-center justify-center w-24 h-24 bg-neutral-100 rounded-3xl mb-6">
