<template>
  <MainLayout>
    <div class="impact-page">
      <!-- Hero Section -->
      <section
        class="bg-gradient-to-br from-primary-50 via-white to-primary-100 py-16 md:py-20"
        style="padding-top: 7rem"
      >
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto text-center">
            <div
              class="inline-flex items-center justify-center w-20 h-20 bg-success/20 rounded-full mb-6"
            >
              <span class="text-5xl">🌍</span>
            </div>
            <h1 class="heading-1 mb-6">Cùng nhau giảm lãng phí thực phẩm</h1>
            <p class="body-lg text-neutral-600">
              Mỗi bữa ăn được nấu từ nguyên liệu sẵn có là một bước nhỏ để bảo
              vệ môi trường
            </p>
          </div>
        </div>
        ...
        <div class="container mx-auto px-4">
          <div class="max-w-6xl mx-auto">
            ...
            <div v-else class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <BaseCard variant="elevated" class="text-center">
                <div
                  class="w-16 h-16 bg-secondary-100 rounded-2xl flex items-center justify-center mx-auto mb-4"
                >
                  <svg
              ...
              <BaseCard variant="elevated" class="text-center">
                <div
                  class="w-16 h-16 bg-success/20 rounded-2xl flex items-center justify-center mx-auto mb-4"
                >
                  <svg
              ...
              <BaseCard variant="elevated" class="text-center">
                <div
                  class="w-16 h-16 bg-info/20 rounded-2xl flex items-center justify-center mx-auto mb-4"
                >
                  <svg
      ...
      <!-- Money Saved -->
      <section
        class="bg-gradient-to-br from-primary-50 to-primary-100 py-12 md:py-16"
      >
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-neutral-600">
              Tổng số tiền cộng đồng đã tiết kiệm được từ việc sử dụng thực phẩm
              có sẵn
            </p>
          </div>
        </div>
            ...
            <div class="space-y-8">
              <BaseCard variant="bordered">
                <div class="flex gap-6 items-start">
                  <div
                    class="w-16 h-16 bg-error/10 rounded-2xl flex items-center justify-center flex-shrink-0"
                  >
                  ...
                  <div>
                    ...
                    <p class="text-neutral-700 leading-relaxed">
                      Theo FAO, hơn <strong>1/3 lượng thực phẩm</strong> sản
                      xuất trên toàn cầu bị lãng phí mỗi năm, tương đương khoảng
                      1.3 tỷ tấn. Ở Việt Nam, mỗi gia đình trung bình vứt đi
              ...
              <BaseCard variant="bordered">
                <div class="flex gap-6 items-start">
                  <div
                    class="w-16 h-16 bg-success/10 rounded-2xl flex items-center justify-center flex-shrink-0"
                  >
                    <span class="text-3xl">🌱</span>
                  </div>
                  <div>
                    ...
                    <p class="text-neutral-700 leading-relaxed">
                      Lãng phí thực phẩm tạo ra
                      <strong>8-10% tổng lượng khí thải nhà kính</strong> toàn
                      cầu. Khi thực phẩm phân hủy ở bãi rác, chúng tạo ra khí
                      methane - một loại khí nhà kính mạnh gấp 25 lần CO₂.
                    </p>
                  </div>
                </div>
              </BaseCard>
              ...
              <BaseCard variant="bordered">
                <div class="flex gap-6 items-start">
                  <div
                    class="w-16 h-16 bg-warning/10 rounded-2xl flex items-center justify-center flex-shrink-0"
                  >
                    <span class="text-3xl">💡</span>
                  </div>
                  <div>
                    ...
                    <p class="text-neutral-700 leading-relaxed">
                      Mỗi bữa ăn được nấu từ nguyên liệu sẵn có trong tủ lạnh
                      không chỉ giúp bạn
                      <strong>tiết kiệm tiền</strong> mà còn góp phần giảm thiểu
                      tác động tiêu cực đến môi trường. Hãy bắt đầu ngay hôm
                      nay!
                    </p>
                  </div>
                </div>
      ...
      <!-- CTA -->
      <section
        class="bg-gradient-to-bl from-primary-500 via-primary-900 to-accent-200 text-white py-12 md:py-16"
      >
        <div class="container mx-auto px-4">
